    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:                               
                ...
                elif isinstance(self.ant,QueenAnt) and self.ant.is_queen == True:
                    self.ant = self.ant
                else:
                    self.ant = None
            else:
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if isinstance(self.ant.ant,QueenAnt) and self.ant.ant.is_queen == True:
        ...
        if hasattr(self.ant, 'container') and self.ant.container:
            ...
            if isinstance(self.ant,QueenAnt) and self.ant.is_queen == True:
                insect.place = insect.place
            else:
                insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while distance < self.min_range:
            distance += 1
            s_place = s_place.entrance

        while Existence == False and s_place!=None and distance <= self.max_range and s_place != hive:
            if s_place.bees:
                Existence = True
                return random_or_none(s_place.bees)
            else:
                s_place = s_place.entrance
                distance += 1
        # END Problem 3B
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, colony):
        ...
        if self.is_queen == False:
            ...
            while s_place != None:
                if s_place.ant:
                    if s_place.ant.container == True:
                        if s_place.ant not in self.total_ants:
                            s_place.ant.damage *= 2
                            self.total_ants.append(s_place.ant)
                        if s_place.ant.ant:
                            if s_place.ant.ant not in self.total_ants:
                                s_place.ant.ant.damage *= 2
                                self.total_ants.append(s_place.ant.ant)
                    else:
                        if s_place.ant not in self.total_ants:
                            s_place.ant.damage *= 2
                            self.total_ants.append(s_place.ant)
                s_place = s_place.exit
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 9
        self.armor -= amount
        if self.is_queen == True and self.armor == 0:
            bees_win()
